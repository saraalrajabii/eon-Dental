  ...
  function GetStarted () {
    ...
    return (
      ...
      <div  className="header-container">
        ...
        <div className="grid-item"> <img src={crowded} className="teeth"/><p>crowded</p></div>
        <div className="grid-item"> <img src={spacing} className="teeth"/><p>spacing</p></div>
        <div className="grid-item"> <img src={crossbite} className="teeth"/><p>crossbite</p></div>
        <div className="grid-item"> <img src={bite_issue} className="teeth"/><p>bite_issue</p></div>
